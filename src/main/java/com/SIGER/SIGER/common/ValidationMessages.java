...
public final class ValidationMessages {
  ...
  public static final String REQUEST_PARAM_EMAIL_ERROR_MESSAGE = "The %s attribute is not in the correct format";
  ...
  public static final String REQUEST_POSITIVE_OR_ZERO_ERROR_MESSAGE = "The %s attribute must be a positive number or 0";
